...
class DataTransformation:
    ...
    def do_data_transformation(self):
        try:
            df = pd.read_csv(os.path.join(self.config.clean_data_file_path))
            ...
            pickle.dump(book_pivot, open(os.path.join(self.config.transformed_data_dir,'book_pivot.pkl'), 'wb'))
